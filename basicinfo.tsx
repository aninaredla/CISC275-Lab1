...
const yourName : String = "Ani Naredla";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Information Systems";
let classification : String = "Junior";
let oneExcite : String = "learning how to use vscode for various problems";
let anyConcerns : String = "working with a lack of git proficiency";
let funFact : String = "i do origami when im bored";
